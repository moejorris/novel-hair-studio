...
@Component({
  ...
  templateUrl: './novel-hair-studio.html',
})
export class NovelHairStudioComponent {
  ...
  galleryImages: GalleryImage[] = [
    ...
    { id: 'photo-1522337360788-8b13dee7a37e',    w: 600, h: 400, alt: 'Dimensional lived-in highlights',       span: ''           },
  ...
  setTab(tab: string): void {
    this.activeTab.set(tab as ServiceTab);
  }
